...
namespace AdventOfCode2015.Config
{
    public static class IoCExtensions
    {
        ...
        private static IServiceCollection ConfigureChallengeModels(IServiceCollection services)
        {
            ...
            services.AddTransient<Challenge17>();
            services.AddTransient<Challenge18>();
            services.AddTransient<Challenge19>();
            services.AddTransient<Challenge20>();
            services.AddTransient<Challenge21>();
            services.AddTransient<Challenge22>();
            services.AddTransient<Challenge23>();
